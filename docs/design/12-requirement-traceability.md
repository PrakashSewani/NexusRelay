...
| Control plane and web | Tooling decision accepted by ADR 0006; Phase 1 OpenAPI source-contract and strict web shell implemented | Expand the authoritative contract and regenerate clients/types with each administrative subsystem; implement functional control-plane and dashboard flows in later phases |
