...
func main() {
	...
	observability.InstallBootstrapLogger("control-plane", os.Stderr)
...
func run(ctx context.Context) error {
	...
	telemetry, err := observability.New(ctx, "control-plane", settings.Shared.Version, settings.Observability, os.Stdout)
	if err != nil {
		return err
	}
